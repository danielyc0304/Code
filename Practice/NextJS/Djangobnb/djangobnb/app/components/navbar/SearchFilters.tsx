const SearchFilters = () => {
  return (
    <div className="flex h-[48px] flex-row items-center justify-between rounded-full border lg:h-[64]">
      ...
      <div className="p-2">
        <div className="bg-airbnb hover:bg-airbnb-dark cursor-pointer rounded-full p-2 text-white transition lg:p-4">
          <svg
            viewBox="0 0 32 32"
            style={{
              display: "block",
